...
const val SVG_CLOSE = "M20 6.91L17.09 4L12 9.09L6.91 4L4 6.91L9.09 12L4 17.09L6.91 20L12 14.91L17.09 20L20 17.09L14.91 12L20 6.91Z"
...
const val SVG_CASE_SENSITIVE_ON = "M8.3,13.3l0.5,1.7H7l0.5-1.7c0.1-0.5,0.3-1.1,0.4-1.6h0C8,12.3,8.1,12.9,8.3,13.3z M16,9v10c0,1.1-0.9,2-2,2H2 c-1.1,0-2-0.9-2-2V9c0-1.1,0.9-2,2-2h1V5c0-2.8,2.2-5,5-5s5,2.2,5,5v2h1C15.1,7,16,7.9,16,9z M5,7h6V5c0-1.7-1.3-3-3-3S5,3.3,5,5V7z M11.6,18.5l-2.5-8.1H6.7l-2.5,8.1h1.9l0.6-2.1h2.3l0.6,2.1H11.6z"
const val SVG_CASE_SENSITIVE_OFF = "M8.3,12.9l0.5,1.7H7l0.5-1.7c0.1-0.5,0.3-1.1,0.4-1.6h0C8,11.8,8.2,12.4,8.3,12.9z M21,5v2h-2V5c0-1.7-1.3-3-3-3s-3,1.3-3,3 v2h1c1.1,0,2,0.9,2,2v10c0,1.1-0.9,2-2,2H2c-1.1,0-2-0.9-2-2V9c0-1.1,0.9-2,2-2h9V5c0-2.8,2.2-5,5-5S21,2.2,21,5z M11.7,18L9.2,10 H6.8L4.3,18h1.9L6.8,16h2.3L9.7,18H11.7z"
